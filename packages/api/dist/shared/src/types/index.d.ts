...
export type EduRevCategory = 'RESEARCH_PAPER' | 'COMPETITION_WIN' | 'CERTIFICATION' | 'PATENT' | 'INTERNSHIP' | 'STARTUP' | 'MOOC';
...
export type LostFoundCategory = 'electronics' | 'bag' | 'wallet' | 'id_card' | 'keys' | 'clothing' | 'books' | 'other';
